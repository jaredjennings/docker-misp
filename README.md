# jaredjennings' MISP container images

My goal in modifying CoolAcid's setup is to package a MISP suitable
for use with Kubernetes and Helm. Kubernetes provides the ConfigMap
and Secret, which are richer ways to provide application configuration
than environment variables passed to startup scripts, and should be
easier to maintain.
